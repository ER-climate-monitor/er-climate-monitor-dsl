...
public class SensorDSLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SensorDSLPackage.eINSTANCE)
			...
			case SensorDSLPackage.SENSOR_REGISTRY_INFO:
				sequence_SensorRegistryInfo(context, (SensorRegistryInfo) semanticObject); 
				return; 
			}
	 ...
	 *
	 * Constraint:
	 *     (((from=DAY to=DAY) | day=DAY) ((type='at' hour=INT minute=INT) | (type='every' value=INT (unit='hours' | unit='minutes'))))
	 * </pre>
	 */
	...
	protected void sequence_GeneralGatewayInfo(ISerializationContext context, GeneralGatewayInfo semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, SensorDSLPackage.Literals.GENERAL_GATEWAY_INFO__PORT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SensorDSLPackage.Literals.GENERAL_GATEWAY_INFO__PORT));
		...
		feeder.accept(grammarAccess.getGeneralGatewayInfoAccess().getPortINTTerminalRuleCall_3_0(), semanticObject.getPort());
		feeder.accept(grammarAccess.getGeneralGatewayInfoAccess().getRegisterSTRINGTerminalRuleCall_5_0(), semanticObject.getRegister());
		feeder.accept(grammarAccess.getGeneralGatewayInfoAccess().getShutdownSTRINGTerminalRuleCall_7_0(), semanticObject.getShutdown());
		feeder.accept(grammarAccess.getGeneralGatewayInfoAccess().getDetectionSTRINGTerminalRuleCall_9_0(), semanticObject.getDetection());
		feeder.accept(grammarAccess.getGeneralGatewayInfoAccess().getAlertSTRINGTerminalRuleCall_11_0(), semanticObject.getAlert());
		feeder.finish();
	}
	 ...
	 * <pre>
	 * Contexts:
	 *     SensorRegistryInfo returns SensorRegistryInfo
	 *
	 * Constraint:
	 *     (registryUrl=STRING apiKey=STRING)
	 * </pre>
	 */
	protected void sequence_SensorRegistryInfo(ISerializationContext context, SensorRegistryInfo semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SensorDSLPackage.Literals.SENSOR_REGISTRY_INFO__REGISTRY_URL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SensorDSLPackage.Literals.SENSOR_REGISTRY_INFO__REGISTRY_URL));
			if (transientValues.isValueTransient(semanticObject, SensorDSLPackage.Literals.SENSOR_REGISTRY_INFO__API_KEY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SensorDSLPackage.Literals.SENSOR_REGISTRY_INFO__API_KEY));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getSensorRegistryInfoAccess().getRegistryUrlSTRINGTerminalRuleCall_1_0(), semanticObject.getRegistryUrl());
		feeder.accept(grammarAccess.getSensorRegistryInfoAccess().getApiKeySTRINGTerminalRuleCall_3_0(), semanticObject.getApiKey());
		feeder.finish();
	}
	...
	protected void sequence_Sensor(ISerializationContext context, Sensor semanticObject) {
		if (errorAcceptor != null) {
			...
			if (transientValues.isValueTransient(semanticObject, SensorDSLPackage.Literals.SENSOR__REGISTRY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SensorDSLPackage.Literals.SENSOR__REGISTRY));
		...
		feeder.accept(grammarAccess.getSensorAccess().getRegistrySensorRegistryInfoParserRuleCall_17_0(), semanticObject.getRegistry());
		feeder.accept(grammarAccess.getSensorAccess().getCronjobGeneralCronjobInfoParserRuleCall_21_0(), semanticObject.getCronjob());
		feeder.finish();
	}
