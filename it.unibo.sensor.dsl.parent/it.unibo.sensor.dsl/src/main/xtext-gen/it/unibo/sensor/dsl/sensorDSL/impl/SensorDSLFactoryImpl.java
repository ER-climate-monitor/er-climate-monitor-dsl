...
public class SensorDSLFactoryImpl extends EFactoryImpl implements SensorDSLFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case SensorDSLPackage.SENSOR_REGISTRY_INFO: return createSensorRegistryInfo();
   ...
   */
  @Override
  public SensorRegistryInfo createSensorRegistryInfo()
  {
    SensorRegistryInfoImpl sensorRegistryInfo = new SensorRegistryInfoImpl();
    return sensorRegistryInfo;
  }
