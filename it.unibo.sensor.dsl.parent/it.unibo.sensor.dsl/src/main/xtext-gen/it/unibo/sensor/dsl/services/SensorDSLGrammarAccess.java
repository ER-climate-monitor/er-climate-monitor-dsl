...
public class SensorDSLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class SensorElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cRegistryKeyword_15 = (Keyword)cGroup.eContents().get(15);
		private final Keyword cLeftCurlyBracketKeyword_16 = (Keyword)cGroup.eContents().get(16);
		private final Assignment cRegistryAssignment_17 = (Assignment)cGroup.eContents().get(17);
		private final RuleCall cRegistrySensorRegistryInfoParserRuleCall_17_0 = (RuleCall)cRegistryAssignment_17.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_18 = (Keyword)cGroup.eContents().get(18);
		private final Keyword cCronjobKeyword_19 = (Keyword)cGroup.eContents().get(19);
		private final Keyword cLeftCurlyBracketKeyword_20 = (Keyword)cGroup.eContents().get(20);
		private final Assignment cCronjobAssignment_21 = (Assignment)cGroup.eContents().get(21);
		private final RuleCall cCronjobGeneralCronjobInfoParserRuleCall_21_0 = (RuleCall)cCronjobAssignment_21.eContents().get(0);
		...
		//'registry'
		public Keyword getRegistryKeyword_15() { return cRegistryKeyword_15; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_16() { return cLeftCurlyBracketKeyword_16; }
		
		//registry=SensorRegistryInfo
		public Assignment getRegistryAssignment_17() { return cRegistryAssignment_17; }
		
		//SensorRegistryInfo
		public RuleCall getRegistrySensorRegistryInfoParserRuleCall_17_0() { return cRegistrySensorRegistryInfoParserRuleCall_17_0; }
		
		//'}'
		public Keyword getRightCurlyBracketKeyword_18() { return cRightCurlyBracketKeyword_18; }
		
		//'cronjob'
		public Keyword getCronjobKeyword_19() { return cCronjobKeyword_19; }
		
		//'{'
		public Keyword getLeftCurlyBracketKeyword_20() { return cLeftCurlyBracketKeyword_20; }
		
		//cronjob=GeneralCronjobInfo
		public Assignment getCronjobAssignment_21() { return cCronjobAssignment_21; }
		
		//GeneralCronjobInfo
		public RuleCall getCronjobGeneralCronjobInfoParserRuleCall_21_0() { return cCronjobGeneralCronjobInfoParserRuleCall_21_0; }
	...
	public class GeneralGatewayInfoElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cRegisterRouteKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final Assignment cRegisterAssignment_5 = (Assignment)cGroup.eContents().get(5);
		private final RuleCall cRegisterSTRINGTerminalRuleCall_5_0 = (RuleCall)cRegisterAssignment_5.eContents().get(0);
		private final Keyword cShutdownRouteKeyword_6 = (Keyword)cGroup.eContents().get(6);
		private final Assignment cShutdownAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cShutdownSTRINGTerminalRuleCall_7_0 = (RuleCall)cShutdownAssignment_7.eContents().get(0);
		private final Keyword cDetectionRouteKeyword_8 = (Keyword)cGroup.eContents().get(8);
		private final Assignment cDetectionAssignment_9 = (Assignment)cGroup.eContents().get(9);
		private final RuleCall cDetectionSTRINGTerminalRuleCall_9_0 = (RuleCall)cDetectionAssignment_9.eContents().get(0);
		private final Keyword cAlertRouteKeyword_10 = (Keyword)cGroup.eContents().get(10);
		private final Assignment cAlertAssignment_11 = (Assignment)cGroup.eContents().get(11);
		private final RuleCall cAlertSTRINGTerminalRuleCall_11_0 = (RuleCall)cAlertAssignment_11.eContents().get(0);
		...
		//'registerRoute'
		public Keyword getRegisterRouteKeyword_4() { return cRegisterRouteKeyword_4; }
		
		//register=STRING
		public Assignment getRegisterAssignment_5() { return cRegisterAssignment_5; }
		
		//STRING
		public RuleCall getRegisterSTRINGTerminalRuleCall_5_0() { return cRegisterSTRINGTerminalRuleCall_5_0; }
		
		//'shutdownRoute'
		public Keyword getShutdownRouteKeyword_6() { return cShutdownRouteKeyword_6; }
		
		//shutdown=STRING
		public Assignment getShutdownAssignment_7() { return cShutdownAssignment_7; }
		
		//STRING
		public RuleCall getShutdownSTRINGTerminalRuleCall_7_0() { return cShutdownSTRINGTerminalRuleCall_7_0; }
		
		//'detectionRoute'
		public Keyword getDetectionRouteKeyword_8() { return cDetectionRouteKeyword_8; }
		
		//detection=STRING
		public Assignment getDetectionAssignment_9() { return cDetectionAssignment_9; }
		
		//STRING
		public RuleCall getDetectionSTRINGTerminalRuleCall_9_0() { return cDetectionSTRINGTerminalRuleCall_9_0; }
		
		//'alertRoute'
		public Keyword getAlertRouteKeyword_10() { return cAlertRouteKeyword_10; }
		
		//alert=STRING
		public Assignment getAlertAssignment_11() { return cAlertAssignment_11; }
		
		//STRING
		public RuleCall getAlertSTRINGTerminalRuleCall_11_0() { return cAlertSTRINGTerminalRuleCall_11_0; }
	}
	public class SensorRegistryInfoElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "it.unibo.sensor.dsl.SensorDSL.SensorRegistryInfo");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRegistryUrlKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cRegistryUrlAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cRegistryUrlSTRINGTerminalRuleCall_1_0 = (RuleCall)cRegistryUrlAssignment_1.eContents().get(0);
		private final Keyword cKeyKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Assignment cApiKeyAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final RuleCall cApiKeySTRINGTerminalRuleCall_3_0 = (RuleCall)cApiKeyAssignment_3.eContents().get(0);
		...
		//'registryUrl'
		public Keyword getRegistryUrlKeyword_0() { return cRegistryUrlKeyword_0; }
		
		//registryUrl=STRING
		public Assignment getRegistryUrlAssignment_1() { return cRegistryUrlAssignment_1; }
		
		//STRING
		public RuleCall getRegistryUrlSTRINGTerminalRuleCall_1_0() { return cRegistryUrlSTRINGTerminalRuleCall_1_0; }
		
		//'key'
		public Keyword getKeyKeyword_2() { return cKeyKeyword_2; }
		
		//apiKey=STRING
		public Assignment getApiKeyAssignment_3() { return cApiKeyAssignment_3; }
		
		//STRING
		public RuleCall getApiKeySTRINGTerminalRuleCall_3_0() { return cApiKeySTRINGTerminalRuleCall_3_0; }
	}
	public class GeneralCronjobInfoElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cTypeAtKeyword_1_0_0_0 = (Keyword)cTypeAssignment_1_0_0.eContents().get(0);
		...
		private final Keyword cTypeEveryKeyword_1_1_0_0 = (Keyword)cTypeAssignment_1_1_0.eContents().get(0);
		...
		private final Assignment cUnitAssignment_1_1_2 = (Assignment)cGroup_1_1.eContents().get(2);
		private final Alternatives cUnitAlternatives_1_1_2_0 = (Alternatives)cUnitAssignment_1_1_2.eContents().get(0);
		private final Keyword cUnitHoursKeyword_1_1_2_0_0 = (Keyword)cUnitAlternatives_1_1_2_0.eContents().get(0);
		private final Keyword cUnitMinutesKeyword_1_1_2_0_1 = (Keyword)cUnitAlternatives_1_1_2_0.eContents().get(1);
		...
		//((type='at' hour=INT ':' minute=INT) | type='every' value=INT unit=('hours' | 'minutes'))
		public Alternatives getAlternatives_1() { return cAlternatives_1; }
		
		//(type='at' hour=INT ':' minute=INT)
		...
		//'at'
		public Keyword getTypeAtKeyword_1_0_0_0() { return cTypeAtKeyword_1_0_0_0; }
		...
		//type='every' value=INT unit=('hours' | 'minutes')
		...
		//'every'
		public Keyword getTypeEveryKeyword_1_1_0_0() { return cTypeEveryKeyword_1_1_0_0; }
		...
		//unit=('hours' | 'minutes')
		public Assignment getUnitAssignment_1_1_2() { return cUnitAssignment_1_1_2; }
		
		//('hours' | 'minutes')
		public Alternatives getUnitAlternatives_1_1_2_0() { return cUnitAlternatives_1_1_2_0; }
		
		//'hours'
		public Keyword getUnitHoursKeyword_1_1_2_0_0() { return cUnitHoursKeyword_1_1_2_0_0; }
		
		//'minutes'
		public Keyword getUnitMinutesKeyword_1_1_2_0_1() { return cUnitMinutesKeyword_1_1_2_0_1; }
	}
	...
	private final SensorRegistryInfoElements pSensorRegistryInfo;
	...
	public SensorDSLGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pSensorRegistryInfo = new SensorRegistryInfoElements();
	...
	//    'registryUrl' registryUrl=STRING
	//    'key' apiKey=STRING;
	public SensorRegistryInfoElements getSensorRegistryInfoAccess() {
		return pSensorRegistryInfo;
	}
	
	public ParserRule getSensorRegistryInfoRule() {
		return getSensorRegistryInfoAccess().getRule();
	}
