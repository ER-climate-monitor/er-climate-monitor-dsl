 ...
 *   <li>{@link it.unibo.sensor.dsl.sensorDSL.impl.SensorImpl#getRegistry <em>Registry</em>}</li>
...
public class SensorImpl extends MinimalEObjectImpl.Container implements Sensor
{
  ...
  /**
   * The cached value of the '{@link #getRegistry() <em>Registry</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getRegistry()
   * @generated
   * @ordered
   */
  protected SensorRegistryInfo registry;
   ...
   */
  @Override
  public SensorRegistryInfo getRegistry()
  {
    return registry;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetRegistry(SensorRegistryInfo newRegistry, NotificationChain msgs)
  {
    SensorRegistryInfo oldRegistry = registry;
    registry = newRegistry;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SensorDSLPackage.SENSOR__REGISTRY, oldRegistry, newRegistry);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   */
  @Override
  public void setRegistry(SensorRegistryInfo newRegistry)
  {
    if (newRegistry != registry)
    {
      NotificationChain msgs = null;
      if (registry != null)
        msgs = ((InternalEObject)registry).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SensorDSLPackage.SENSOR__REGISTRY, null, msgs);
      if (newRegistry != null)
        msgs = ((InternalEObject)newRegistry).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SensorDSLPackage.SENSOR__REGISTRY, null, msgs);
      msgs = basicSetRegistry(newRegistry, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SensorDSLPackage.SENSOR__REGISTRY, newRegistry, newRegistry));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case SensorDSLPackage.SENSOR__REGISTRY:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case SensorDSLPackage.SENSOR__GATEWAY:
        ...
        return;
      case SensorDSLPackage.SENSOR__REGISTRY:
        setRegistry((SensorRegistryInfo)newValue);
        return;
      case SensorDSLPackage.SENSOR__CRONJOB:
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case SensorDSLPackage.SENSOR__GATEWAY:
        ...
        return;
      case SensorDSLPackage.SENSOR__REGISTRY:
        setRegistry((SensorRegistryInfo)null);
        return;
      case SensorDSLPackage.SENSOR__CRONJOB:
