...
public class NetworkUtils {
    public static boolean isValid(@NonNull final String ip) {
        final String regexIpv4 = "^((25[0-5]|(2[0-4]|1[0-9]|[1-9]|)[0-9])(\\.(?!$)|$)){4}$";
        ...
        return Pattern.matches(regexIpv4, ip) || Pattern.matches(regexIpv6, ip);
    }
}
